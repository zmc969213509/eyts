...
import com.guojianyiliao.eryitianshi.MyUtils.manager.ThreadManager;
...
public abstract class LoadingPage extends FrameLayout {
	...
	private View onCreateLoadingView() {
		return UIUtils.getinflate(R.layout.layout_loading);
	}
	...
	private View onCreateErrorView() {
		return UIUtils.getinflate(R.layout.layout_error);
	}
	...
	private View onCreateEmptyView() {
		return UIUtils.getinflate(R.layout.layout_empty);
	}
