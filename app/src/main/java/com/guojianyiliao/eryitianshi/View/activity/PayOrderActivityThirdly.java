...
public class PayOrderActivityThirdly extends MyBaseActivity implements View.OnClickListener {
    ...
    private void init() {
        ...
        payZfb.setOnClickListener(PayOrderActivityThirdly.this);
        payWx.setOnClickListener(PayOrderActivityThirdly.this);
        btPayment.setOnClickListener(PayOrderActivityThirdly.this);
        tvPaypoucon.setOnClickListener(PayOrderActivityThirdly.this);
        tvClose.setOnClickListener(PayOrderActivityThirdly.this);
        btPayment.setOnClickListener(PayOrderActivityThirdly.this);
