...
public class PayOrderActivityTwo extends MyBaseActivity implements View.OnClickListener {
    ...
    private void init() {
        ...
        payZfb.setOnClickListener(PayOrderActivityTwo.this);
        payWx.setOnClickListener(PayOrderActivityTwo.this);
        btPayment.setOnClickListener(PayOrderActivityTwo.this);
        tvPaypoucon.setOnClickListener(PayOrderActivityTwo.this);
        tvClose.setOnClickListener(PayOrderActivityTwo.this);
        btPayment.setOnClickListener(PayOrderActivityTwo.this);
        ...
        switch (v.getId()) {
            ...
            case R.id.bt_payment:
                ...
                if (i1 + i2 + i3 >= 25) {
                    ...
                    ToolUtils.showToast(PayOrderActivityTwo.this, "代金券金额不够支付！", Toast.LENGTH_SHORT);
                }
                break;
            case R.id.tv_close:
                finish();
