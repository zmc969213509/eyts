...
public class UserAgreementActivity extends MyBaseActivity {
    ...
    private void findView() {
        ...
        tv.setText("本协议是您与儿医天使客户端（简称本客户端）所有者（以下简称为儿医天使）之间就儿医天使客户端服务等相关事宜所订立的契约，请您仔细阅读本注册协议，您点击注册按钮后，本协议即构成对双方有约束力的法律文件。\n第1条本客户端服务条款的确认和接纳\n" +
                "1.1. 本客户端的各项电子服务的所有权和运作权归成都天使儿童医院所有。用户同意所有注册协议条款并完成注册程序，才能成为本客户端的正式用户。用户确认：本协议条款是处理双方权利义务的契约，始终有效，法律另有强制性规定或双方另有特别约定的，依其规定。\n" +
                "1.2. 用户点击同意本协议的，即视为用户确认自己具有享受本客户端提供的权利和行为能力，能够独立承担法律责任。\n" +
                "1.3. 如果您在18周岁以下，您只能在父母或监护人的监护下使用本客户端。\n" +
                "1.4. 儿医天使保留在中华人民共和国大陆地区施行之法律允许的范围内独自决定拒绝服务、关闭用户账户、清除或编辑内容或取消预约挂号的权利。\n" +
                "第2条本客户端服务\n" +
                ...
                " 第5条商品信息 \n" +
                "本客户端上的服务价格、数量、能否提供等信息随时都有可能发生变动，本客户端不作特别通知。本客户端显示的信息可能会有一定的滞后性或差错，对此情形您知悉并理解；天使儿医欢迎纠错，并会视情况给予纠错者一定的奖励。为表述便利，产品和服务简称为产品或服务。\n" +
                " 第6条预约挂号\n" +
                "6.1. 在您预约挂号时，请您仔细确认所预约服务的名称、价格、注意事项、联系电话、联系人等信息。联系人与用户本人不一致的，联系人的行为和意思表示视为用户的行为和意思表示，用户应对联系人的行为及意思表示的法律后果承担连带责任。\n" +
                "6.2. 除法律另有强制性规定外，双方约定如下：\n" +
                "（1）本客户端上儿医天使展示的服务和价格等信息仅仅是要约邀请，您提交时须填写您希望预约的服务的联系人、联系方式、时间等内容；\n" +
                "（2）系统生成的信息是计算机信息系统根据您填写的内容自动生成的数据，仅是您向儿医天使发出的合同要约；\n" +
                "（3）儿医天使收到您的预约信息后，只有在儿医天使工作人员致电确认您的信息后，方视为您与儿医天使之间就您或指定联系人建立了合同关系；\n" +
                "（4）只有在儿医天使实际向您或指定联系人提供了订单中订购的其他服务时，您和儿医天使之间就订单中该其他已实际向您或指定联系人提供的服务才成立合同关系；\n" +
                "（5）您可以随时登陆您在本客户端注册的账户，查询您的预约详情。\n" +
                ...
                "第7条配送\n" +
                "7.1. 儿医天使将会把产品（服务）发送到您或指定联系人所指定的接收端等，所有在本客户端列出的交付时间为参考时间，参考时间的计算是根据具体服务的处理过程和发送时间的基础上估计得出的。\n" +
                "7.2. 因如下情况造成预约服务无法确认或交付的，儿医天使不承担延迟交付的责任：\n" +
                "（1）用户提供的联系方式错误、用户操作导致接受不到确认信息的；\n" +
                "（2）服务发送后无人查阅的；\n" +
                "（3）情势变更因素导致的；\n" +
                ...
                "第9条责任限制及不承诺担保 \n" +
                "除非另有明确的书面说明，本客户端及其所包含的或以其它方式通过本客户端提供给您的全部信息、内容、材料、产品（包括软件）和服务，均是在按现状和按现有的基础上提供的。除非另有明确的书面说明，儿医天使不对本客户端的运营及其包含在本客户端上的信息、内容、材料、产品（包括软件）或服务作任何形式的、明示或默示的声明或担保（根据中华人民共和国法律另有规定的以外）。\n" +
                ...
                "成都天使儿童医院致力于提供正确、完整的健康资讯，但不保证信息的正确性和完整性，且不对因信息的不正确或遗漏导致的任何损失或损害承担责任。\n" +
                "儿医天使所提供的任何医疗信息，仅供参考，不能替代医生和其他医务人员的建议，如自行使用儿医天使中资料发生偏差，成都天使儿童医院概不负责，亦不负任何法律责任。\n" +
                "《在线问诊》模块中的服务提供者均为拥有中华人民共和国医师资格证书的专业医生。但咨询建议仅为依据提问者描述而提供建议性内容，不能作为诊断及医疗的依据。\n" +
                "是否采用儿医天使的医生意见为提问者个人行为，成都天使儿童医院不承担任何可能产生的责任。 \u2028        成都天使儿童医院保留对本声明作出不定时修改的权利。\n" +
                "第10条服务内容\n" +
                "10.1. 咨询服务条款 \n" +
                "本条款所称咨询特指用户通过本客户端提交的咨询信息和通过预约特定医生的电话咨询，咨询的交互主体为本客户端的用户和儿医天使介绍的医生。\n" +
                ...
                "13.4. 您点击本协议上方的同意以下协议，提交按钮即视为您完全接受本协议，在点击之前请您再次确认已知悉并完全理解本协议的全部内容。\n" +
                "成都天使儿童医院\n" +
                "\n" +
                "\n" +
                "\n" +
